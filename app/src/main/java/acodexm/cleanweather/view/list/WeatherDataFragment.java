...
public class WeatherDataFragment extends Fragment implements Injectable {
    ...
    private void setupRecyclerView(View v) {
        ...
        adapter = new WeatherDataAdapter(new ArrayList<>(), getContext(), itemClickListener, deleteClickListener);
